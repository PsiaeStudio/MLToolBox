...
class DirectInstallUEPakModScreenState(
    ...
    fun pickUE4PakModsArchive(awtWindow: java.awt.Window) {
    ...
    private suspend fun processSelectedModsArchive(mods: List<jFile>): Boolean {
        ...
        withContext(Dispatchers.IO) {
            ...
            val installDir = jFile(userDir.absolutePath + "\\temp\\ue_pak_mods_install")
            run {
            ...
            mods.forEach { file ->
                val dest = jFile(System.getProperty("user.dir") + "\\temp\\ue_pak_mods_install\\${file.name}")
            ...
            val modsInstallDir = System.getProperty("user.dir") + "\\temp\\ue_pak_mods_install"
