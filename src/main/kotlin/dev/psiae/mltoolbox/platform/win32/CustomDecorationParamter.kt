package dev.psiae.mltoolbox.platform.win32
...
object CustomDecorationParameters {
    ...
    private var _titleBarHeight = AtomicInteger(45)
    ...
    @Volatile
    var controlBoxRightOffset = 0

    @Volatile
    var controlBoxTopOffset = 0

    @Volatile
    var controlBoxHeight = 0
}